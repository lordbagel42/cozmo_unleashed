...
def cozmo_unleashed(robot: cozmo.robot.Robot):
	...
	wall_obj1 = robot.world.define_custom_wall(CustomObjectTypes.CustomType05, CustomObjectMarkers.Diamonds2, 340, 120, 40, 40, True)
	wall_obj2 = robot.world.define_custom_wall(CustomObjectTypes.CustomType02, CustomObjectMarkers.Diamonds3, 340, 120, 40, 40, True)
	wall_obj3 = robot.world.define_custom_wall(CustomObjectTypes.CustomType03, CustomObjectMarkers.Diamonds4, 340, 120, 40, 40, True)
	wall_obj4 = robot.world.define_custom_wall(CustomObjectTypes.CustomType04, CustomObjectMarkers.Diamonds5, 340, 120, 40, 40, True)
	...
	chargermarker1 = robot.world.define_custom_wall(CustomObjectTypes.CustomType01, CustomObjectMarkers.Hexagons2, 60, 60, 60, 60, True)
